<div class="">
  <div class="flex items-center mr-6 mt-6 ">
    <form class="" action="/tweets/{{$tweet->id}}/like" method="post">
      @csrf
      <div class="flex items-center mr-6 ">
        <button type="submit" class="flex">
        <svg viewBox="0 0 20 20" class="text-green-500 mr-1 w-5">
    ...
    <span class="text-md text-gray-500 ">{{$tweet->likes ?: 0}}</span>
    </button>
    ...
    <div class="flex items-center">
      <button type="submit" class="flex">
      <svg viewBox="0 0 20 20" class="text-red-500 mr-1 w-5">
          <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g class="fill-current">
  ...
  <span class="text-md text-gray-500 ">{{$tweet->dislikes ?: 0}}</span>
</button>
</div>
</form>
